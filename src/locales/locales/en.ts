const locale: Record<string, string> = {
  ...
  'editor.AI.shortcuts.generate.flowchart': 'Generate Flowchart',
  'editor.AI.shortcuts.generate.table': 'Generate Table',
  'editor.AI.shortcuts.generate.translate': 'Translate',
  ...
  'editor.comment.edit': 'Edit Comment',
  'editor.comment.delete': 'Delete Comment',
  'editor.comment.reply': 'Reply',
  'editor.comment.resolve': 'Resolve',
  'editor.comment.placeholder': 'Add a comment...',
  'editor.comment.submit': 'Submit',
  'editor.comment.cancel': 'Cancel',
  'editor.comment.error': 'Comment Error',
  'editor.comment.success': 'Comment Success',
  'editor.comment.addSuccess': 'Comment added successfully',
  'editor.comment.editorNotFound': 'Editor not found',
