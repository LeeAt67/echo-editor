const locale: Record<string, string> = {
  ...
  'editor.columns.tooltip': '两栏',
  'editor.threeColumns.tooltip': '三栏',
  'editor.fourColumns.tooltip': '四栏',
  ...
  'editor.AI.shortcuts.generate.improve': '改写内容',
  'editor.AI.shortcuts.generate.shorter': '缩写内容',
  'editor.AI.shortcuts.generate.longer': '扩写内容',
  'editor.AI.shortcuts.generate.summarize': '总结内容',
  'editor.AI.shortcuts.generate.flowchart': '生成流程图',
  'editor.AI.shortcuts.generate.table': '生成表格',
  'editor.AI.shortcuts.generate.translate': '翻译内容',
  ...
  'editor.codeblock.selectTheme': '选择主题',
  ...
  'editor.comment.edit': '编辑评论',
  'editor.comment.delete': '删除评论',
  'editor.comment.reply': '回复',
  'editor.comment.resolve': '标记为已解决',
  'editor.comment.placeholder': '输入评论内容...',
  'editor.comment.submit': '提交',
  'editor.comment.cancel': '取消',
  'editor.comment.error': '评论错误',
  'editor.comment.success': '评论成功',
  'editor.comment.addSuccess': '评论添加成功',
  'editor.comment.editorNotFound': '未找到编辑器',
